...
public interface IFormulatorService {
	// 获取版本下已经有的BOM视图中的原材料
	...
	// 获取查询到的原材料
	List<MaterialBean> getSearchBean(List<TCComponentItemRevision> materialRevList);
	...
	//作为缓存使用的一个topBomLine
	TCComponentBOMLine getCacheTopBomLine(List<TCComponentItemRevision> formulatorItemRevList, List<MaterialBean> formulatorBeanList);
