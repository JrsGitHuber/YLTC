...
public final class JDateChooser extends JDialog {
    ...
    public static void main(String[] args) {
        ...
        JDateChooser gg = new JDateChooser(null, "");
        gg.showDateChooser();
        System.out.println(gg.getDateFormat("yyyy-MM-dd"));
    }
    
    public static String GetDate(Rectangle rectangle, String dateStr) throws Exception {
        UIManager.setLookAndFeel(UIManager.getSystemLookAndFeelClassName());
        
        JDateChooser gg = new JDateChooser(rectangle, dateStr);
        gg.showDateChooser();
        
        return gg.getDateFormat("yyyy-M-d").toString();
    }
     ...
     * 构造方法
     */
    public JDateChooser(Rectangle rectangle, String dateStr) {
        initComponent();
        initComponentData(dateStr);
        addComponent();
        addListener();
        setDialogAttribute(rectangle);
    }
     ...
     * 初始化组件数据
     */
    private void initComponentData(String dateStr) {
        if (!dateStr.equals("")) {
    ...
    private int parseYearOrMonth(String yearOrMonth) {
        return Integer.parseInt(yearOrMonth.substring(0,
                yearOrMonth.length() - 1));
    }
     ...
     * 设置对话框属性
     */
    private void setDialogAttribute(Rectangle rectangle) {
        ...
        // ImageIcon(this.getClass().getResource("/calendar.png"))).getImage());
    }
    ...
    final class ComboBoxItemListener implements ItemListener {
        ...
        public void itemStateChanged(ItemEvent e) {
            if (e.getSource() == jcbYear) {
                int year = parseYearOrMonth(jcbYear.getSelectedItem()
                        .toString());
                ...
                int month = parseYearOrMonth(jcbMonth.getSelectedItem()
                        .toString());
